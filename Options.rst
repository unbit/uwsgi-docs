...
.. _OptionMin-worker-lifetime:

``min-worker-lifetime``
~~~~~~~~~~~~~~~~
**Argument:** number

One of the 1.9 new features was the improved anti-fork bombing policy. A worker cannot be destroyed/reloaded unless it has been alive for N seconds (default 60).

.. _OptionMax-worker-lifetime:
