...
`SIGTERM`   brutally reload all the workers and the master process                    (use ``--die-on-term`` on versions < 2.1 to respect the convention of shutting down the instance)
