...
def core_options():
    ...
    with config.section("uWSGI Process") as s:
        ...
        s.o("stop", "pidfile", "send the stop (SIGINT) signal to the instance described by the pidfile", docs=["ProcessSignals"])
        s.o("reload", "pidfile", "send the reload (SIGHUP) signal to the instance described by the pidfile", docs=["ProcessSignals"])
        s.o("pause", "pidfile", "send the pause (SIGTSTP) signal to the instance described by the pidfile", docs=["ProcessSignals"])
        s.o("suspend", "pidfile", "send the suspend (SIGTSTP) signal to the instance described by the pidfile", docs=["ProcessSignals"])
        s.o("resume", "pidfile", "send the resume (SIGTSTP) signal to the instance described by the pidfile", docs=["ProcessSignals"])
